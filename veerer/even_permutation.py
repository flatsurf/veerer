...
The set `X_n` comes with a canonical involution `i \mapsto -i-1` (note
that `-i-1` is the bit complement to `i`). The commutator of this
canonical involution are the signed permutations.
"""
...
def even_perm_base64_str(p):
    n = len(p) / 2
    l = int(log(2*n, 64)) + 1 # number of digits used for each entry
    return ''.join(int_to_base64(i + n, l) for i in p)
...
def even_perm_from_base64_str(s, n):
    ...
    if len(s) != (2 * n * l):
        raise ValueError
    return [base64_to_int(s[i:i+l])-n for i in range(0,len(s),l)]
...
def signed_permutations(n):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import signed_permutations
...
def even_perm_check(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_check
...
def even_perm_identity(n):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_identity
...
def even_perm_minus(n):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_minus
...
def even_perm_is_orientable(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_is_orientable
...
def even_perm_cycles(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_cycles
...
def even_perm_invert(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import (even_perm_invert,
...
def even_perm_compose(p1, p2):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_compose
...
def even_perm_is_transitive(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_is_transitive
...
def even_perm_tilde(p):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import even_perm_tilde
        sage: even_perm_tilde([1r, 0r, -1r, -2r])
        array('l', [1, 0, -1, -2])
        sage: even_perm_tilde([1r, -1r, -2r, 0r])
        array('l', [-1, 1, 0, -2])

        sage: from veerer.even_permutation import even_permutations, is_signed_perm
...
def even_perm_relabel(p, m):
    ...
    EXAMPLES::
        ...
        sage: from veerer.even_permutation import (even_perm_relabel,
...
def even_perm_canonical_label_from(p, i):
    ...
    EXAMPLES::
        ...
        sage: from array import array
        sage: from veerer.even_permutation import (even_perm_canonical_label_from,
        ....:     is_signed_perm)
