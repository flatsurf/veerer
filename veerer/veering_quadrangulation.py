...
def least_rotation(S):
    """
    Return the pair ``(index of smallest rotation, period)``.
...
class VeeringQuadrangulation:
    ...
    def relabel(self, p):
        ...
        EXAMPLES::
            ...
            True
            sage: ans,p = Q1.is_isomorphic(Q2, True)
            sage: Q1.relabel(p)
            sage: Q1 == Q2
            True
        """
...
def ferenczi_zamboni_class(k, labelled=False):
    ...
    EXAMPLES::
        ...
        sage: len(ferenczi_zamboni_class(3, labelled=True))
        9
        sage: len(ferenczi_zamboni_class(3, labelled=False))
        3

        sage: len(ferenczi_zamboni_class(4, labelled=True))
        28
        sage: len(ferenczi_zamboni_class(4, labelled=False))
        10
    """
