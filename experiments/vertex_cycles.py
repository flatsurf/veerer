...
if __name__ == '__main__':
    ...
    # test_all_in(QuadraticStratum(2, 2))
    # test_all_in(QuadraticStratum(2, 1, 1))
    # test_all_in(AbelianStratum(4).odd_component())
    # test_all_in(AbelianStratum(2,2).hyperelliptic_component())
    test_all_in(QuadraticStratum(8).unique_component())
